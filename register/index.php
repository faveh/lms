...
require_once "../include/signuperrors.php";

if(isset($_GET['msg']) && $_GET['msg'] == 'success') {
    $alert_content = nl2br("Account Registration Successful! "."\n"."<kbd>Check Your Email</kbd>"." "."<strong><a href='../'>Go Home to Login</a></strong>");
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="col-lg-6">
                            <!--Sign Up-->
                            <h2 class="text-info text-center">LMS Registration Form <small class="text-danger">(Fill All)</small></h2>
                            <form action="<?php echo $ld; ?>processor/register.php" method="POST">
                                <fieldset>
